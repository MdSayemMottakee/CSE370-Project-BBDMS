...
{   
    ...
    if(isset($_POST['submit'])) {
		...
		$sql_check = "SELECT * FROM HospitalLocation WHERE City = :city AND Zip = :zip";
		...
		if($count > 0) {
			...
			$sql_bloodbank = "INSERT INTO Hospital(Name, Street, City) VALUES(:name, :street, :city)";
			...
			$msg = "Hospital Bank added successfully";

		} else {
			// Insert data into BloodBankLocation table if city and zip do not exist
			$sql_location = "INSERT INTO HospitalLocation(City, Zip) VALUES(:city, :zip)";
...
<head>
    ...
    <title>BBDMS | Add Hospital</title>
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading">Add Hospital</div>
